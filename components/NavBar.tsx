...
const NavBar = () => {
  ...
  return (
    <>
      {showSidebar ? (
        <button
          className="flex text-4xl text-white items-center cursor-pointer fixed right-10 top-5 z-50 hover:text-pink-300"
      ...
      <div
        className={`top-0 right-0 w-[60vw] sm:w-[40vw] bg-slate-100 dark:bg-gray-950  p-10 dark:text-white fixed h-full z-40  ease-in-out duration-500 ${
