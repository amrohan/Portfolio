...
const NavBar = () => {
  ...
  return (
    <div className="w-fill  h-5 justify-center fixed inset-3 z-40">
      <header className="p-2 bg-transparent rounded-xl dark:text-gray-100  w-auto">
        <div className="container flex justify-end  h-12 mx-auto">
          ...
          <ul className="items-stretch hidden space-x-3 md:flex">
            ...
            {/* GitHub */}
            <li className="flex h-full pt-3 hover:text-purple-300 ">
            ...
            {/* Instagram */}
            <li className="flex h-full pt-3 hover:text-pink-300">
            ...
            {/* Twitter */}
            <li className="flex h-full pt-3 hover:text-blue-400">
