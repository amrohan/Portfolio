...
export default function Home() {
  return (
    <>
      ...
      />
      <section className="text-gray-400 bg-gray-950 overflow-hidden">
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 md:mb-0 mb-10">
            <img
              className=" mx-auto object-center rounded w-3/6 md:w-9/12"
              alt="hero"
              src="/hero.svg"
              width={300}
              height={300}
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            ...
            <div className="flex justify-center">
              <button className="inline-flex text-white border-pink-600 border-2 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded text-lg">
                <Link href="/blog">
